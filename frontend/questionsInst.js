                    ...
                    <div class="question-content" onclick="toggleAnswer(this)">
                        ...
                        <div class="answer-section">
                            ...
                            <div class="button-container">
                                <button class="see-answers"   onclick="window.location.href = 'respostaDuvidaInstitucional.html'; localStorage.setItem('question_id', ${element.id});">Ver Respostas</button>
